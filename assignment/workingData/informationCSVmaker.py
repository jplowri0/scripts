...
CVEcodeTxt = open("informationCVECode/informationCVECodeAll.txt", "r")
...
ratingCodeTxt = open("informationRatingCode/informationRatingCodeAll.txt", "r")
...
desCodeTxt = open("informationDesCode/InformationDesCodeAll.txt", "r")
...
with open('scrapedInformation.csv', "w") as f:
    writer = csv.writer(f)
    for row in rows:
        writer.writerow(row)

with open('scrapedInformation.csv', 'r') as inputCSV, open('scrapedInformationTSV.txt', 'w') as outputTSV:
