...
CVEcodeTxt = open("privelegesCVECode/privelegesCVEcode1.txt", "r")
...
ratingCodeTxt = open("privelegesRatingCode/privelegesRatingCode1.txt", "r")
...
desCodeTxt = open("privelegesDesCode/privelegesDesCode1.txt", "r")
...
with open('scrapedPriveleges.csv', "w") as f:
    writer = csv.writer(f)
    for row in rows:
        writer.writerow(row)

with open('scrapedPriveleges.csv', 'r') as inputCSV, open('scrapedPrivelegesTSV.txt', 'w') as outputTSV:
